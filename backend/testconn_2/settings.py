"""
Django settings for testconn_2 project.
...
WSGI_APPLICATION = "testconn_2.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testconn_2 API",
    "DESCRIPTION": "API documentation for testconn_2 App",
    "VERSION": "v1",
}
